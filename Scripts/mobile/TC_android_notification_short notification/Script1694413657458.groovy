...
Mobile.tap(findTestObject('Application/Android3/android.widget.Button - Show Short Notification'), 0)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'Short notification\']')
